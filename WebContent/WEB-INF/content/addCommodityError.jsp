    ...
    <div id="wrapper">
                    ...
                    <li>
					 ...
					 <li>
						...
						<ul class="nav nav-second-level  collapse in">
							<li>
                                <a class="active-menu" href="http://localhost:8080/DBLab3/addCommodity"><i class="fa fa-coffee"></i>添加商品</a>
                            </li>
							<li>
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">添加商品信息</h1>
                ...
                <div class="panel panel-success">
                        ...
                        添加商品信息失败
                          ...
                          <hr>
                           <a href="http://localhost:8080/DBLab3/addCommodity" class="btn btn-danger">重新添加</a> 
                        </div> 
                        </div>
                 </div>
             </div>
