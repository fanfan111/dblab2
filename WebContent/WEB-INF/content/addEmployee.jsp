    ...
    <div id="wrapper">
					...
					<li>
                        <a href="#"><i class="fa fa-yelp "></i>员工管理 <span class="fa arrow"></span></a>
                         <ul class="nav nav-second-level collapse in">
                            <li>
                                <a class="active-menu" href="http://localhost:8080/DBLab3/addEmployee"><i class="fa fa-coffee"></i>员工入职登记</a>
                            </li>
                            <li>
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">员工入职登记</h1>
               ...
               <div class="panel panel-success">
                        ...
                        <div class="panel-body">
                            <form role="form" action="addemployee">
                            	<div class="form-group">
                                	<label>员工编号</label>
                                   	<input class="form-control" type="text" name="Enum">
                                </div>
                                <div class="form-group">
                                	<label>姓名</label>
                                ...
                                <div class="radio"><label><input type="radio" name="sex" id="sex" value="男" />男</label></div>
              					 <div class="radio"><label><input type="radio" name="sex" id="sex" value="女" />女</label></div>
                                </div>
                                <div class="form-group">
                                	<label>职务</label>
                                ...
                                <div class="form-group">
                                	<label>权限级别</label>
                                	 <div class="radio"><label><input type="radio" name="level"  value="0" />普通员工</label></div>
              						 <div class="radio"><label><input type="radio" name="level"  value="1" />高层员工</label></div>
                                </div>
                                <div class="form-group">
                                	<label>身份证号</label>
                                ...
                                <div class="form-group">
                                	<label>所属部门</label>
                                	<div class="radio"><label><input type="radio" name="dnum" value="0001" />宣传部</label></div>
              						<div class="radio"><label><input type="radio" name="dnum" value="0002" />销售部</label></div>
              						<div class="radio"><label><input type="radio" name="dnum" value="0003" />采购部</label></div>
              						<div class="radio"><label><input type="radio" name="dnum" value="0004" />后勤部</label></div>
                                </div>
                                <div class="form-group">
                                	<label>主管领导</label>
                                	<input class="form-control" type="text" name="superEnum" value="">
                                </div>
                                <button type="submit" class="btn btn-success">录入信息</button>
							</form>
                        </div>
                 </div>
             </div>
