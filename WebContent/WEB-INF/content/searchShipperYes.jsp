    ...
    <div id="wrapper">
                ...
                <ul class="nav" id="main-menu">
                    ...
                    <li>
						...
						<ul class="nav nav-second-level collapse in">
                            ...
                            <li>
                                <a class="active-menu" href="http://localhost:8080/DBLab3/searchShipper"><i class="fa fa-flash "></i>出售信息查询</a>
                            </li> 
                        </ul>
                    </li>
                    <li>
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">在职员工查询</h1>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    ...
                                    <tbody>
         <%
			mainShipper p = (mainShipper) request.getAttribute("search_main");
		%>
                                        <tr>
                                             <td><%=p.MSnum %></td>
                                            <td><%=p.outdate %></td>
                                    ...
                                    <tbody>
         <%
			List<subshipper> list = (List<subshipper>) request.getAttribute("search_sub");
			for (Object ele : list) {
				subshipper q = (subshipper) ele;
