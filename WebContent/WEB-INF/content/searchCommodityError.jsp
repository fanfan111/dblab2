    ...
    <div id="wrapper">
                    ...
                    <li>
					 ...
					 <li>
						...
						<ul class="nav nav-second-level  collapse in">
                            ...
                            <li>
                                <a class="active-menu"href="http://localhost:8080/DBLab3/searchCommodity"><i class="fa fa-flash "></i>详情查询</a>
                            </li>						
                        </ul>
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">商品信息查询</h1>
               ...
               <!-- /. ROW  -->
                ...
                <div class="panel panel-success">
                        ...
                        商品信息查询失败
                          ...
                          <hr>
                           <a href="http://localhost:8080/DBLab3/searchCommodity" class="btn btn-danger">重新查询</a> 
                        </div> 
                        </div>
                 </div>
             </div>
