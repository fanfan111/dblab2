    ...
    <div id="wrapper">
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
					 ...
					 <li>
						...
						<ul class="nav nav-second-level">
							...
							<li>
                                <a href="invoice.html"><i class="fa fa-coffee"></i>详情查询</a>
                            </li>
                            <li>
                                <a href="pricing.html"><i class="fa fa-flash "></i>信息修改</a>
                            </li>						
                        </ul>
                     ...
                     <li>
						...
						<ul class="nav nav-second-level collapse in  ">
                            <li>
                                <a class="active-menu" href="http://localhost:8080/DBLab3/addMember"><i class="fa fa-coffee"></i>新会员登记</a>
                            </li>
                            <li>
                    ...
                    <li>
                        <a href="login.html"><i class="fa fa-sign-in "></i>出售记录</a>
                    </li>
                    <li>
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">新会员登记</h1>
               ...
               <div class="panel panel-success">
                        ...
                        <div class="panel-body">
                            <form role="form" action="addmember">
