    ...
    <div id="wrapper">
					...
					<li>
                        <a href="#"><i class="fa fa-yelp "></i>员工管理 <span class="fa arrow"></span></a>
                         <ul class="nav nav-second-level collapse in">
                            ...
                            <li>
                                <a class="active-menu"  href="http://localhost:8080/DBLab3/deleteEmployee"><i class="fa fa-flash "></i>员工离职登记</a>
                            </li>
                             <li>
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">员工离职登记</h1>
               ...
               <div class="panel panel-success">
                        ...
                        <div class="panel-body">
                            <form role="form" action="deleteemployee">
                            	<div class="form-group">
                                	<label>员工编号</label>
                                   	<input class="form-control" type="text" name="enum">
                                </div>
                               
                                <button type="submit" class="btn btn-success">申请离职</button>
							</form>
                        </div>
                 </div>
             </div>
