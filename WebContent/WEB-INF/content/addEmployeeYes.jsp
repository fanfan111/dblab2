                ...
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                     ...
                     <li>
						...
						<ul class="nav nav-second-level">
                            <li>
                                <a href="invoice.html"><i class="fa fa-coffee"></i>新会员登记</a>
                            </li>
                            <li>
                                <a href="pricing.html"><i class="fa fa-flash "></i>会员信息查询</a>
                            </li> 
                        </ul>
            ...
            <div id="page-inner">
               ...
               <div class="panel panel-success">
                        ...
                        员工信息录入成功
                          ...
                          <hr>
                           <a href="http://localhost:8080/DBLab3/deleteEmployee" class="btn btn-success">继续录入</a> 
                        </div> 
                        </div>
                 </div>
             </div>
