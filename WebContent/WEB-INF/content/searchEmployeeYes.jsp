...
<%@page import="connect.JDBC.Employee"%>
                        ...
                        <a href="#"><i class="fa fa-yelp "></i>员工管理 <span class="fa arrow"></span></a>
                         <ul class="nav nav-second-level collapse in">
                            ...
                            <li>
                             ...
                             <li>
                                <a class="active-menu"  href="http://localhost:8080/DBLab3/searchEmployee"><i class="fa fa-key "></i>在职员工查询</a>
                            </li>
                             <li>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    ...
                                    <tbody>
         <%
			List<Employee> list = (List<Employee>) request.getAttribute("search_employee");
			for (Object ele : list) {
				Employee p = (Employee) ele;
